...
#include "numbers.h"
  ...
  // 01111110 => 126
 // struct bits8 bits8_obj4 = { .b0 = { .v = false }, .b1 = { .v = true }, .b2 = { .v = true }, .b3 = { .v = true }, .b4 = { .v = true }, .b5 = { .v = true }, .b6 = { .v = true }, .b7 = { .v = false } };

  // 00000001 => 1
  struct bits8 bits8_obj5 = { .b0 = { .v = true }, .b1 = { .v = false }, .b2 = { .v = false }, .b3 = { .v = false }, .b4 = { .v = false }, .b5 = { .v = false }, .b6 = { .v = false }, .b7 = { .v = false } };

  //11111111 => -1 (used as a two componment bit)
  struct bits8 bits8_neg_one = { .b0 = { .v = true }, .b1 = { .v = true }, .b2 = { .v = true }, .b3 = { .v = true }, .b4 = { .v = true }, .b5 = { .v = true }, .b6 = { .v = true }, .b7 = { .v = true } };
  //00001010 => 10
  struct bits8 bits8_obj6 = { .b0 = { .v = false }, .b1 = { .v = true }, .b2 = { .v = false }, .b3 = { .v = true }, .b4 = { .v = false }, .b5 = { .v = false }, .b6 = { .v = false }, .b7 = { .v = false } };
  //11110110 => -10
      struct bits8 bits8_obj7 = {
        .b0 = { .v = false },
        .b1 = { .v = true },
        .b2 = { .v = true },
        .b3 = { .v = false },
  ...
  // 00000101 => 5
  struct bits8 bits8_obj8 = { .b0 = { .v = true }, .b1 = { .v = false }, .b2 = { .v = true }, .b3 = { .v = false }, .b4 = { .v = false }, .b5 = { .v = false }, .b6 = { .v = false }, .b7 = { .v = false } };

  // 00000010 => 2
  struct bits8 bits8_obj9 = { .b0 = { .v = false }, .b1 = { .v = true }, .b2 = { .v = false }, .b3 = { .v = false }, .b4 = { .v = false }, .b5 = { .v = false }, .b6 = { .v = false }, .b7 = { .v = false } };
   struct bits8 sum_170_1 = { .b0 = { .v = true }, .b1 = { .v = true }, .b2 = { .v = false }, .b3 = { .v = true }, .b4 = { .v = false }, .b5 = { .v = true }, .b6 = { .v = false }, .b7 = { .v = true } };

void test_bits8_from_int(unsigned int x, struct bits8 expectedBit) {
  struct bits8 byte = bits8_from_int(x);

  // Check if the converted bits match the expected bits
  if (byte.b0.v != expectedBit.b0.v ||
      byte.b1.v != expectedBit.b1.v ||
      byte.b2.v != expectedBit.b2.v ||
      byte.b3.v != expectedBit.b3.v ||
      byte.b4.v != expectedBit.b4.v ||
      byte.b5.v != expectedBit.b5.v ||
      byte.b6.v != expectedBit.b6.v ||
      byte.b7.v != expectedBit.b7.v) {

    printf("test bits8 from int: \n");    
    printf("Input:     %u\n", x);
    printf("Got:       %u%u%u%u%u%u%u%u\n", byte.b7.v, byte.b6.v, byte.b5.v, byte.b4.v, byte.b3.v, byte.b2.v, byte.b1.v, byte.b0.v);
...
int main(void) {
  ...
  test_bits8_to_int(bits8_obj2, 0);
   ...
   // Test addition
  // Example: 170 (bits8_obj3) + 1 (bits8_obj5) = 171
  test_bits8_add(bits8_obj3, bits8_obj5, sum_170_1);




  //test of negation of -1 = 1
  test_bits8_negate(bits8_neg_one, bits8_obj5);
  //test of negation of 10 = -10
  test_bits8_negate(bits8_obj6,bits8_obj7);

  //test of mul 2*5 = 10
  test_bits8_mul(bits8_obj9,bits8_obj8,bits8_obj6);
  //test of mul 10 * 0 = 0
  test_bits8_mul(bits8_obj6,bits8_obj2,bits8_obj2);
